...
def main():
    # Check if the upload page should be displayed
    if getattr(st.session_state, 'introduce_page', True):
        introduce_page()
        
    # Create a button to navigate to the upload page
    if st.button("Go to Upload Page"):
        st.session_state.show_upload_page = True  # Store a flag to indicate that the upload page should be shown
        st.session_state.introduce_page = False  # Store a flag to indicate that the upload page should be shown

    # Check if the upload page should be displayed
    if getattr(st.session_state, 'show_upload_page', False):
        show_upload_page()
